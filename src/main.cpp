...
// ============================================================
    ...
    while(!shouldQuitGame) {
        ...
        if (g_gameState == STATE_GAMEPLAY && !isRoofCamActive && !showQuitConfirm && !g_mainMenuSystem.IsSettingsModalShowing() && !g_mainMenuSystem.IsDossierModalShowing() && !isShopOpen) {
        ...
        if (g_gameState == STATE_MAIN_MENU || g_gameState == STATE_PAUSED) {
            ...
            if (IsKeyPressed(KEY_ESCAPE) && !showQuitConfirm && !isShopOpen && !IsATMActive() && !g_mainMenuSystem.IsSettingsModalShowing() && !g_showManifestModal) {
                isCursorCaptured = !isCursorCaptured;
                if (isCursorCaptured) DisableCursor();
                else EnableCursor();
            }
        ...
        if (escCooldown > 0.0f) {
            ...
            if (g_gameState == STATE_MAIN_MENU) {
                ...
                if (g_showSettingsModal || g_showCaseFilesModal || g_showSurvivalModal) {
                    ...
                    g_mainMenuSystem.ShowSettingsModal(false);

                    g_mainMenuSystem.ShowCaseFilesModal(false);

                    g_mainMenuSystem.ShowSurvivalModal(false);
                ...
                if (isRoofCamActive) {
                    ...
                    g_mainMenuSystem.ShowDossierModal(false);
        ...
        bool canSprint = (onGround || g_waterState == WATER_STATE_SURFACE || g_waterState == WATER_STATE_DIVING) && !g_isHoldingCart && !isShopOpen && !showQuitConfirm && !g_mainMenuSystem.IsSettingsModalShowing() && !g_showManifestModal && (g_gameState == STATE_GAMEPLAY);
            ...
            if (camera.position.y < 9.0f) {
                ...
                // E. Clandestine Dossier Interaction (North end of worktable)
                    ...
                    if (IsKeyPressed(KEY_E) && !g_mainMenuSystem.IsDossierModalShowing()) {
                        ...
                        g_mainMenuSystem.ShowDossierModal(true);
...
// (Shovel relocated to outside near carpet)
        ...
        if (g_gameState == STATE_MAIN_MENU) {
            g_mainMenuSystem.Update(dt);
            g_mainMenuSystem.Draw(screenW, screenH, timeVal);
        ...
        // =========================================================================
            ...
            if (g_mainMenuSystem.IsShowingAnyModal()) {
                g_mainMenuSystem.Draw(screenW, screenH, timeVal);
            } else {
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    if (i == 0 && (clicked || enterPressed || IsKeyPressed(KEY_ONE))) {
                        ...
                        g_mainMenuSystem.ShowSettingsModal(true);
                        ...
                        g_mainMenuSystem.ShowCaseFilesModal(true);
